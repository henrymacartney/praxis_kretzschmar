					...
					<div class="flex flex-col sm:flex-row gap-4 justify-center">
						...
						<?php if ( $hero_cta_secondary_label ) : ?>
							<a
								...
								class="inline-block px-7 py-3 font-sans text-sm tracking-wide uppercase border border-cream-100 text-cream-50 hover:bg-cream-50 hover:text-navy-800 transition-colors"
							>
