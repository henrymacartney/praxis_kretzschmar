...
$fortbildungen   = get_field( 'ueber_mich_fortbildungen' );
$berufserfahrung = get_field( 'ueber_mich_berufserfahrung' );
?>
		...
		<?php if ( $fortbildungen ) : ?>
			<section class="py-12 md:py-16 bg-cream-100 border-t border-cream-200">
				<div class="mx-auto max-w-3xl px-6">
					...
					<div class="font-sans text-base md:text-lg leading-relaxed text-stone-800 prose prose-stone max-w-none">
						<?php echo wp_kses_post( $fortbildungen ); ?>
					</div>
				</div>
			</section>
		<?php endif; ?>
		
		<?php if ( $berufserfahrung ) : ?>
			<section class="py-12 md:py-16 bg-cream-50 border-t border-cream-200">
				<div class="mx-auto max-w-3xl px-6">
					<h2 class="font-display text-3xl font-medium text-navy-800 mb-6">
						Berufserfahrung
					</h2>
					<div class="font-sans text-base md:text-lg leading-relaxed text-stone-800 prose prose-stone max-w-none">
						<?php echo wp_kses_post( $berufserfahrung ); ?>
					</div>
				</div>
			</section>
		<?php endif; ?>
